...
def calculate_wakefields(laser, beam_part, r_max, xi_min, xi_max, n_r, n_xi,
    ...
    psi_mesh = np.zeros((n_r+1, n_xi))
    dr_psi_mesh = np.zeros((n_r+1, n_xi))
    dxi_psi_mesh = np.zeros((n_r+1, n_xi))
    b_theta_bar_mesh = np.zeros((n_r+1, n_xi))
    b_theta_0_mesh = np.zeros((n_r+1, n_xi))
    r_arr = np.linspace(0, r_max, n_r+1)
