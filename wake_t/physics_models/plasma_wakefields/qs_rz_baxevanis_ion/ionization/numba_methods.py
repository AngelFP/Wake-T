    ...
    for i_batch in range( N_batch ):
        ...
        for ip in range(i_batch*batch_size, N_max):
            ...
            if level >= level_max:
                ...
                p = get_ionization_probability( E, gamma[ip],
...
def copy_ionized_electrons_numba(
    ...
    elec_r, elec_dr_p, elec_pr, elec_pz,
    elec_gamma, elec_w, elec_m, elec_q,
    ion_r, ion_dr_p, ion_pr, ion_pz,
    ion_gamma, ion_w, ion_m, ion_q
):
    """
    ...
    # return( elec_r, elec_dr_p, elec_pr, elec_pz,
    #         elec_gamma, elec_w, elec_m, elec_q )
